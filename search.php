			...
			<table class="table table-striped table-hover table-bordered">
				...
				<?php
					$no=1;
					$sql=mysql_query("select*from penelitian where pel_judul like '%$_POST[cari]%' or pel_penulis like '%$_POST[cari]%'");
				...
				?>
                    <tr>
                      ...
                      <td><center><a href="index.php?modul=penelitiandosen&act=view&id=<?php echo $data[id_m];?>"><img src="webadmin/image/webcam.png"></a></td>
					</tr>
				<?php
				$no++;
					}
